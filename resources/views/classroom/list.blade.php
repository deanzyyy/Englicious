        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div id="classroom-list" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($classrooms as $classroom)
                    <div id="classroom-{{ $classroom->id }}" class="bg-[#211F27] rounded-xl border-2 border-transparent hover:border-pink-500 transition-all duration-200 relative">
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between mt-6 pt-4 border-t border-gray-700">
                                ...
                                @if(Auth::id() === $classroom->teacher_id || (Auth::user() && Auth::user()->role === 'admin'))
                                    <button onClick="confirmDelete({{ $classroom->id }}, '{{ $classroom->name }}')"
