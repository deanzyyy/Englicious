<x-layout>
    {{-- <form method="POST" action="{{ route('exercises.store') }}">
        ...
        <!-- Title, Description, Classroom, Category -->
    ...
    <!-- Template Soal (disembunyikan dulu) -->
    <template id="task-template">
        <div class="task-box">
            <input type="text" name="questions[__INDEX__][question]" placeholder="Enter Question" required>
            <div>
                <input type="text" name="questions[__INDEX__][answers][]" placeholder="Option A" required>
                <input type="radio" name="questions[__INDEX__][correct]" value="0"> Correct
            </div>
            <div>
                <input type="text" name="questions[__INDEX__][answers][]" placeholder="Option B" required>
                <input type="radio" name="questions[__INDEX__][correct]" value="1"> Correct
            </div>
            <div>
                <input type="text" name="questions[__INDEX__][answers][]" placeholder="Option C" required>
                <input type="radio" name="questions[__INDEX__][correct]" value="2"> Correct
            </div>
            <button type="button" class="remove-task">Hapus Soal</button>
        </div>
    </template> --}}
    ...
    <div class="mx-25">
        ...
        <div class="container p-2">
            <div class="content bg-[#211F27] p-10 rounded-lg">
                ...
                <form method="POST" action="{{ route('exercises.store') }}" class="space-y-6 max-w-4xl" enctype="multipart/form-data">
                    @csrf
                    <!-- Common Fields -->
