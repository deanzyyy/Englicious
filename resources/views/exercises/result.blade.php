        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-[#211F27] rounded-lg overflow-hidden shadow-lg border border-pink-500/20">
                ...
                <div class="p-6 border-b border-gray-700">
                    ...
                    <p class="text-gray-400">{{ $exercise->title }}</p>
                </div>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="mt-2">
                                                    @if(isset($submission->essay_scores[$question->id]))
                                                        <span class="text-green-400 font-semibold">Nilai: {{ $submission->essay_scores[$question->id] }}</span>
                                                        @if(isset($submission->essay_comments[$question->id]))
                                                            <div class="text-gray-400 mt-1">Komentar: {{ $submission->essay_comments[$question->id] }}</div>
                                                        @endif
                                                    @else
                ...
                <div class="p-6 border-t border-gray-700 flex justify-end space-x-4">
                    <a href="{{ route('exercises.take.general', ['id' => $exercise->id]) }}" 
