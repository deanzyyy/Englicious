  ...
  <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-pink-400 opacity-20 rounded-full blur-[100px] mix-blend-screen circle-anim-3"></div>
    ...
    <header class=" px-6 py-4 flex items-center justify-between">
        ...
        <div class="flex flex-cols z-50 items-center space-x-2">
          <img src="{{ url('img/EngliciousLogo.png') }}" alt="Logo" class="w-15 h-15">
  ...
  <div class="All-Container flex justify-center items-start">
    <div class="content items-center m-5">
      ...
      <div class="bottom flex items-center justify-center space-x-5 mt-10">
        <a href="{{ route('login') }}" class="w-36 h-10 px-2 rounded-full text-white bg-gradient-to-r from-pink-500 to-orange-500 flex items-center justify-center text-center">Login</a>
        <a href="{{ route('register') }}" class="w-36 h-10 px-2 rounded-full text-pink-500 border-2 border-pink-500 flex items-center justify-center text-center">Register</a>
      </div>
        ...
        <div class="relative w-full max-w-7xl flex items-center justify-center z-10">
          ...
          <div class="overflow-hidden w-full">
            <div class="slide-animation flex gap-16 items-center py-2">
              <img src="{{ url('img/poli.png') }}" alt="Logo 1" class="h-15 w-auto grayscale hover:grayscale-0 transition duration-300 drop-shadow-lg hover:scale-110" />
              <img src="{{ url('img/ti.png') }}" alt="Logo 2" class="h-15 w-auto grayscale hover:grayscale-0 transition duration-300 drop-shadow-lg hover:scale-110" />
              <img src="{{ url('img/raft.png') }}" alt="Logo 3" class="h-15 w-auto grayscale hover:grayscale-0 transition duration-300 drop-shadow-lg hover:scale-110" />
              <img src="{{ url('img/gp.png') }}" alt="Logo 4" class="h-15 w-auto grayscale hover:grayscale-0 transition duration-300 drop-shadow-lg hover:scale-110" />
    ...
    <div class="mx-25 my-15 flex flex-cols justify-center items-center">
      ...
      <div class="content right">
          <div>
            <img src="{{ url('img/tablet.png')}}" alt="englicious" class="h-auto w-[800px] -rotate-10">
          </div>
      </div>
    </div>
...
<footer class="w-full bg-gradient-to-b from-[#211021] via-[#18182a] to-[#101014] py-10 px-4 mt-20 border-t border-[#2a2a32]">
  <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
    ...
    <div class="flex items-center space-x-4 mb-6 md:mb-0">
      <img src="{{ url('img/EngliciousLogo.png') }}" alt="Englicious Logo" class="w-16 h-16 rounded-full shadow-lg">
      <div>
  ...
  <div class="mt-10 text-center text-gray-500 text-xs">
    &copy; {{ date('Y') }} Englicious. All rights reserved.
  </div>
</footer>
