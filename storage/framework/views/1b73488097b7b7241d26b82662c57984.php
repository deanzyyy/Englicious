        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center select-none pointer-events-none">
            <div>
                <span class="mx-auto mb-4 w-14 h-14 block">
                    <img src="<?php echo e(asset('img/VocaLogoOnly.png')); ?>" alt="Voca AI" width="56" height="56" class="w-14 h-14">
                </span>
                ...
                <!--[if BLOCK]><![endif]--><?php if(auth()->user()->role === 'teacher' || auth()->user()->role === 'admin'): ?>
    ...
    <div class="flex flex-col gap-4 px-2 pb-4 pt-2" style="min-height:calc(100vh - 6.5rem);">
        <div class="flex-1 flex flex-col gap-4 overflow-y-auto" id="chat-messages">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="w-full flex <?php echo e($msg['role'] === 'user' ? 'justify-end' : 'justify-start'); ?>">
                    <div class="max-w-[80%] px-4 py-3 rounded-xl shadow border <?php echo e($msg['role'] === 'user' ? 'bg-gradient-to-r from-pink-500 to-orange-500 text-white border-pink-500/30' : 'bg-[#18171d] text-white border-pink-500/10'); ?>">
                        <span class="whitespace-pre-line text-base"><?php echo e($msg['text']); ?></span>
                    </div>
                </div>
...
</div><?php /**PATH D:\Englicious\Englicious\resources\views/livewire/gen-ai-chat.blade.php ENDPATH**/ ?>