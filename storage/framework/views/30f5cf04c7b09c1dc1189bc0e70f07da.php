...
<div class="min-h-screen bg-gradient-to-br from-[#211F27] via-[#2A2833] to-[#1A1A1A] p-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="max-w-2xl mx-auto">
            <form method="POST" action="<?php echo e(route('teacher.registration.simple.register')); ?>" class="space-y-8">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Englicious\Englicious\resources\views/auth/teacher-registration-simple.blade.php ENDPATH**/ ?>