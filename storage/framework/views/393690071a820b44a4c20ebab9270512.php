    ...
    <div class="mx-25">
        ...
        <div class="container p-2">
            <div class="content bg-[#211F27] p-10 rounded-lg">
                <form action="<?php echo e(route('materials.store')); ?>" method="POST" enctype="multipart/form-data" id="materialForm">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-6">
                        <!-- Title -->
                        <div>
...
<?php endif; ?> <?php /**PATH D:\Englicious\Englicious\resources\views/materials/create.blade.php ENDPATH**/ ?>