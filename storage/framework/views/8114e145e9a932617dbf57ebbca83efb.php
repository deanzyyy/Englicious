...
<div class="mt-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-400 text-lg mt-2">Educational games for <?php echo e($classroom->name); ?></p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-[#211F27] rounded-lg shadow-lg border border-pink-500/20 p-6 hover:border-pink-500/40 transition-all">
            <div class="flex justify-between items-start mb-4">
                <div>
                    <h3 class="text-xl font-semibold text-white mb-2"><?php echo e($game->name); ?></h3>
                    <p class="text-gray-400 text-sm"><?php echo e($game->exercise->title); ?></p>
                </div>
            ...
            <div class="space-y-2 mb-4">
                ...
                <div class="flex justify-between text-sm">
                    ...
                    <span class="text-white"><?php echo e($game->creator->name); ?></span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-400">Questions:</span>
                    <span class="text-white"><?php echo e($game->exercise->questions_count); ?></span>
                </div>
            </div>
...
<?php echo $__env->make('classroom.show', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Englicious\Englicious\resources\views/classroom/games/index.blade.php ENDPATH**/ ?>