    ...
    <div class="mx-25">
        ...
        <div class="container p-2">
            <div class="content bg-[#211F27] p-10 rounded-lg">
                <form action="<?php echo e(route('materials.update', $material->id)); ?>" method="POST" enctype="multipart/form-data" id="materialForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" required
                                ...
                                value="<?php echo e($material->title); ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="w-full bg-[#1a1a1f] text-white rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-pink-500"
                                placeholder="Enter material description"><?php echo e($material->description); ?></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="category" id="category" required onchange="loadTopics()"
                                    ...
                                    <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryTopics): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category); ?>" <?php echo e($material->topic->category === $category ? 'selected' : ''); ?>>
                                            <?php echo e($category); ?>
                            ...
                            <div>
                                ...
                                <select name="topic_id" id="topic_id" required onchange="loadSubtopics()"
                                    ...
                                    <?php $__currentLoopData = $topics[$material->topic->category]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($topic->id); ?>" <?php echo e($material->topic_id === $topic->id ? 'selected' : ''); ?>>
                        ...
                        <div>
                            ...
                            <select name="subtopic_id" id="subtopic_id" required
                                ...
                                <?php $__currentLoopData = $subtopics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subtopic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subtopic->id); ?>" <?php echo e($material->subtopic_id === $subtopic->id ? 'selected' : ''); ?>>
    ...
    <script>
        ...
        function handleBack() {
            if (hasUnsavedChanges) {
                ...
                window.location.href = '<?php echo e(route("materials.index")); ?>';
            }
        }
        ...
        function loadTopics() {
            ...
            if (category) {
                <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryTopics): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    if ('<?php echo e($category); ?>' === category) {
                        <?php $__currentLoopData = $categoryTopics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            option.textContent = '<?php echo e($topic->name); ?>';
...
<?php endif; ?> <?php /**PATH D:\Englicious\Englicious\resources\views/materials/edit.blade.php ENDPATH**/ ?>