...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <?php if(Auth::check() && Auth::user()->role === 'teacher' && Auth::user()->id === $classroom->teacher_id): ?>
            ...
            <ul class="divide-y divide-gray-700">
                <?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        <div>
                            <div class="text-lg font-semibold text-white"><?php echo e($schedule->title); ?></div>
                            <div class="text-gray-400 text-sm mb-1"><?php echo e($schedule->date); ?> | <?php echo e(substr($schedule->start_time,0,5)); ?> - <?php echo e(substr($schedule->end_time,0,5)); ?></div>
                            <div class="text-gray-300 text-sm"><?php echo e($schedule->description); ?></div>
                        </div>
                        <?php if(Auth::check() && Auth::user()->role === 'teacher' && Auth::user()->id === $classroom->teacher_id): ?>
                        <div class="flex gap-2 mt-2 md:mt-0">
                            <button onclick="editSchedule(<?php echo e($schedule->id); ?>, '<?php echo e(addslashes($schedule->title)); ?>', '<?php echo e(addslashes($schedule->description)); ?>', '<?php echo e($schedule->date); ?>', '<?php echo e(substr($schedule->start_time,0,5)); ?>', '<?php echo e(substr($schedule->end_time,0,5)); ?>')" class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 text-xs">Edit</button>
                            <form action="<?php echo e(route('classroom.schedules.destroy', [$classroom->name, $schedule->id])); ?>" method="POST" onsubmit="return confirm('Delete this schedule?')">
                                <?php echo csrf_field(); ?>
...
<script>
    function openScheduleModal() {
        ...
        document.getElementById('schedule-form').action = "<?php echo e(route('classroom.schedules.store', $classroom->name)); ?>";
    ...
    function editSchedule(id, title, description, date, start, end) {
        ...
        document.getElementById('schedule-form').action = "<?php echo e(url('classroom/'.$classroom->name.'/schedules')); ?>/" + id;
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('classroom.show', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Englicious\Englicious\resources\views/classroom/schedules/index.blade.php ENDPATH**/ ?>