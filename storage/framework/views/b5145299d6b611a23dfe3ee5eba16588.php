    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-[#211F27] rounded-lg overflow-hidden shadow-lg border border-pink-500/20">
            ...
            <div class="p-6 border-b border-gray-700">
                ...
                <p class="text-gray-400"><?php echo e($exercise->title); ?> - <?php echo e($classroom->name); ?></p>
            </div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <div class="mt-2">
                                                <?php if(isset($submission->essay_scores[$question->id])): ?>
                                                    <span class="text-green-400 font-semibold">Score: <?php echo e($submission->essay_scores[$question->id]); ?></span>
                                                    <?php if(isset($submission->essay_comments[$question->id])): ?>
                                                        <div class="text-gray-400 mt-1">Comment: <?php echo e($submission->essay_comments[$question->id]); ?></div>
                                                    <?php endif; ?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Englicious\Englicious\resources\views/classroom/exercise-result.blade.php ENDPATH**/ ?>