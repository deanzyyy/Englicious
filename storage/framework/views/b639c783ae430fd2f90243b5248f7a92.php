                            ...
                            <?php if($classrooms->count() > 0): ?>
                                <?php $__currentLoopData = $classrooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classroom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(Auth::user()->role === 'admin' || Auth::id() === $classroom->teacher_id): ?>
                                        <div id="classroom-<?php echo e($classroom->id); ?>" class="flex-none w-[280px] bg-[#211F27] rounded-xl hover:border-2 hover:border-pink-500 transition-all duration-200">
