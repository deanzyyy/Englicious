  ...
  <div class="pt-3">
    ...
    <?php if(Auth::check() && Auth::user()->role === 'student'): ?>
        ...
        <div class="container mx-auto px-8 py-6 max-w-[1200px]">
            <p class="text-gray-400 text-lg mb-2">Welcome, <?php echo e(Auth::user()->name); ?>,</p>
        ...
        <?php if(isset($latestExercises) && count($latestExercises) > 0): ?>
        <div id="latest-exercise-section" class="container mx-auto px-8 py-6 max-w-[1200px]">
            ...
            <div class="space-y-6">
                <?php $__currentLoopData = $latestExercises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-[#211F27] rounded-xl shadow p-6 flex flex-col w-full max-w-none">
                    <h3 class="text-2xl font-bold text-white mb-2"><?php echo e($exercise->title); ?></h3>
                    <p class="text-gray-300 text-base mb-2"><?php echo e($exercise->description); ?></p>
                    <div class="flex items-center text-xs text-gray-400 mb-2">
                        <span class="mr-4"><i class="fi fi-rr-calendar"></i> <?php echo e($exercise->created_at->format('d M Y')); ?></span>
                        <span class="mr-4"><i class="fi fi-rr-user"></i> By <?php echo e($exercise->creator->name ?? '-'); ?></span>
                    </div>
                    <a href="/exercises/<?php echo e($exercise->id); ?>/take" class="mt-auto bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600">Take Exercise</a>
                </div>
        ...
        <?php if(isset($latestMaterials) && count($latestMaterials) > 0): ?>
        <div id="latest-materials-section" class="container mx-auto px-8 py-6 max-w-[1200px]">
            ...
            <div class="space-y-6">
                <?php $__currentLoopData = $latestMaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-[#211F27] rounded-xl shadow p-6 flex flex-col w-full max-w-none">
                    <h3 class="text-2xl font-bold text-white mb-2"><?php echo e($material->title); ?></h3>
                    <p class="text-gray-300 text-base mb-2"><?php echo e($material->description); ?></p>
                    <div class="flex items-center text-xs text-gray-400 mb-2">
                        <span class="mr-4"><i class="fi fi-rr-calendar"></i> <?php echo e($material->created_at->format('d M Y')); ?></span>
                    </div>
                    <?php if($material->file_path): ?>
                    <a href="<?php echo e(asset('storage/'.$material->file_path)); ?>" target="_blank" class="mt-auto bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600">View Material</a>
                    <?php endif; ?>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="Container-judul flex justify-center items-center">
                <div class="px-36 flex pt-25">
                    <div class="w-[500px] space-y-2">
                        ...
                        <h1 class="text-white font-bold text-5xl"><?php echo e(auth()->user()->name); ?></h1>
                        <p class="text-gray-400">you are a <?php echo e(auth()->user()->role); ?> in Englicious, Happy teaching</p>
                        ...
                        <div class="flex gap-6 pb-4" id="your-classroom-list">
                            <?php if($classrooms->count() > 0): ?>
                                <?php $__currentLoopData = $classrooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classroom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(Auth::user()->role === 'admin' || Auth::id() === $classroom->teacher_id): ?>
                                        <div id="classroom-<?php echo e($classroom->id); ?>" class="flex-none w-[280px] bg-[#211F27] rounded-xl hover:border-2 hover:border-pink-500 transition-all duration-200 relative">
                                            <div class="p-5 flex flex-col h-[200px]">
                                                <div class="flex-1 flex flex-row justify-between items-start">
                                                    <div>
                                                        <h3 class="text-xl font-bold text-white mb-2 truncate"><?php echo e($classroom->name); ?></h3>
                                                        <p class="text-gray-400 text-sm line-clamp-2"><?php echo e($classroom->description); ?></p>
                                                    </div>
                                                    <div class="relative group">
                                                        <button class="text-white p-1 hover:bg-pink-500/20 rounded-full" onclick="toggleMenu('menu-<?php echo e($classroom->id); ?>')">
                                                        ...
                                                        <div id="menu-<?php echo e($classroom->id); ?>" class="hidden absolute right-0 mt-2 w-40 bg-[#211F27] border border-gray-700 rounded-lg shadow-lg z-10">
                                                            <button onclick="openChangePasswordModal('<?php echo e($classroom->name); ?>')" class="block w-full text-left px-4 py-2 text-white hover:bg-pink-500/20">Change Password</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flex items-center justify-between pt-4 border-t border-gray-700">
                                                    ...
                                                    <?php if(Auth::id() === $classroom->teacher_id || (Auth::user() && Auth::user()->role === 'admin')): ?>
                                                        <button onClick="openDeleteModal(<?php echo e($classroom->id); ?>, '<?php echo e($classroom->name); ?>')" 
                                        ...
                                        <div class="p-5 flex flex-col h-[200px]">
                                            <div class="flex-1">
                                                <div class="flex items-center gap-2 mb-3">
                                                    ...
                                                    <span class="text-sm text-pink-500"><?php echo e($exercise->category); ?></span>
                                                </div>
                                                <h3 class="text-xl font-bold text-white mb-2 truncate"><?php echo e($exercise->title); ?></h3>
                                                <p class="text-gray-400 text-sm line-clamp-2"><?php echo e($exercise->description); ?></p>
                                            </div>
                                            <div class="flex items-center justify-between pt-4 border-t border-gray-700">
                                                <?php if($exercise->is_file_upload): ?>
                                                    <a href="/preview/<?php echo e($exercise->id); ?>" 
                                                       class="bg-gradient-to-r from-pink-500 to-orange-500 text-white px-4 py-2 rounded-lg hover:opacity-90 transition-opacity">
                                                        View PDF
                                                    </a>
                                                <?php else: ?>
                                                    <a href="/exercises/<?php echo e($exercise->id); ?>/take" 
                                                       class="bg-gradient-to-r from-pink-500 to-orange-500 text-white px-4 py-2 rounded-lg hover:opacity-90 transition-opacity">
                                                        Take Exercise
                                                    </a>
                                                <?php endif; ?>
...
<?php endif; ?><?php /**PATH D:\Englicious\Englicious\resources\views/Home.blade.php ENDPATH**/ ?>