    ...
    <div class="ml-10 p-10">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <p class="text-lg text-gray-400 mt-2">Total: <?php echo e($total_materials); ?> <?php echo e(Str::plural('Material', $total_materials)); ?></p>
            </div>
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex space-x-4">
                ...
                <?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('materials.index', ['category' => $category])); ?>" 
        ...
        <?php elseif($materials->count() > 0): ?>
            <div class="space-y-4">
                <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $topicGroups): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="material-category" data-category="<?php echo e($category); ?>">
                        <!-- Category Header -->
                        <div class="mb-4">
                            <h2 class="text-2xl font-bold text-white flex items-center">
                                <i class="fi fi-rr-graduation-cap mr-3 text-pink-500"></i>
                                <?php echo e($category); ?> Materials
                            </h2>
                        </div>

                        <!-- Topics List -->
                        <div class="space-y-4">
                            <?php $__currentLoopData = $topicGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topicName => $topicMaterials): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-[#211F27] rounded-lg overflow-hidden">
                                    ...
                                    <div class="flex items-center justify-between p-4 border-l-4 border-pink-500">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <span class="text-gray-400">(<?php echo e($topicMaterials->count()); ?> <?php echo e(Str::plural('Material', $topicMaterials->count())); ?>)</span>
                                        </div>
                                        <button onclick="window.toggleSubtopics('<?php echo e(str_replace(' ', '_', $topicName)); ?>')" class="text-gray-400 hover:text-white transition-colors">
                                    ...
                                    <!-- Subtopics Container -->
                                    <div id="subtopics-<?php echo e(str_replace(' ', '_', $topicName)); ?>" class="hidden">
                                        <?php
                                        ...
                                        <?php $__currentLoopData = $subtopicGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subtopicName => $materials): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="ml-8 p-4 bg-[#1a1a1f] rounded-lg mx-4 mb-4">
                                                <div class="flex items-center justify-between mb-3">
                                                    ...
                                                    <span class="text-gray-400 text-sm"><?php echo e($materials->count()); ?> <?php echo e(Str::plural('Material', $materials->count())); ?></span>
                                                </div>
                                                ...
                                                <div class="space-y-3 mt-4">
                                                    <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="flex items-center justify-between py-2 px-4 bg-[#211F27] rounded-lg hover:bg-[#2a2833] transition-all duration-300">
                                                            <div class="flex-grow">
                                                                <div class="flex items-center space-x-3">
                                                                    <h5 class="text-white font-medium"><?php echo e($material->title); ?></h5>
                                                                </div>
                                                                <p class="text-gray-400 text-sm mt-1"><?php echo e($material->description ?: 'No description'); ?></p>
                                                                <?php if($material->creator): ?>
                                                                    <p class="text-gray-500 text-xs mt-1"><i class="fi fi-rr-user mr-1"></i>By <?php echo e($material->creator->name); ?></p>
                                                                <?php endif; ?>
                                                            ...
                                                            <div class="flex items-center space-x-2">
                                                                ...
                                                                <?php if(auth()->user()->role !== 'student'): ?>
                                                                <button onclick="window.showSendToClassModal(<?php echo e($material->id); ?>)" 
                                                                        class="px-3 py-1 text-pink-500 hover:text-white border border-pink-500 rounded hover:bg-gradient-to-r from-pink-500 to-orange-500 transition-all">
                                                                    <i class="fi fi-rr-paper-plane"></i>
                                                                </button>
                                                                <button onclick="window.editMaterial(<?php echo e($material->id); ?>)" 
                                                                ...
                                                                <button onclick="window.deleteMaterial(<?php echo e($material->id); ?>)" 
            ...
            <div class="bg-[#211F27] rounded-lg shadow-lg border border-white/20 p-8 text-center">
                ...
                <p class="text-gray-400 mb-4">
                    <?php if(request('category')): ?>
                        No materials found in the <?php echo e(request('category')); ?> category.
                    <?php else: ?>
        ...
        <!-- Add Topic Modal -->
        <?php echo $__env->make('partials.add-topic-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?> <?php /**PATH D:\Englicious\Englicious\resources\views/materials/index.blade.php ENDPATH**/ ?>